    ...
    <PageWrapper>
      <Section title="Our Team" subtitle="Meet the Minds Behind AIRLAB">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-10">
          {leadingTeam.map((member) => (
            <Card
              key={member.id}
              className="text-center overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 group flex flex-col"
            >
